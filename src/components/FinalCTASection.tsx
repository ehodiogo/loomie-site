          ...
          >
            <h2 className="font-display text-3xl md:text-5xl font-extrabold leading-tight text-foreground">
              ...
              <span className="text-gradient-primary">
                Comece a construir o seu ativo.
              </span>
            </h2>
            ...
            >
              {badges.map(({ icon: Icon, text, href }) =>
                href ? (
                  <motion.a
                    key={text}
                    variants={fadeUpItem}
                    ...
                    className="flex items-center gap-2 glass-panel px-4 py-2 hover:bg-white/10 transition-colors"
                  >
                    <Icon className="w-4 h-4 text-primary" />
                    <span className="text-sm text-foreground font-medium underline underline-offset-4 decoration-primary/50">
                      {text}
                    </span>
                  </motion.a>
                ) : (
